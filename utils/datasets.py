...
def img2feat_paths(img_paths):
    # Define label paths as a function of image paths
    sa, sb = os.sep + 'images' + os.sep, os.sep + 'feats' + os.sep  # /images/, /feats/ substrings
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.feat_files = img2feat_paths(self.img_files)  # feats
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            # Load mosaic
            img, labels, feats = load_mosaic(self, index)
            shapes = None
        ...
        return torch.from_numpy(img), labels_out, self.img_files[index], shapes, feats_out
    ...
    def collate_fn(batch):
        ...
        return torch.stack(img, 0), torch.cat(label, 0), path, shapes, torch.cat(feat, 0)
    ...
    def collate_fn4(batch):
        ...
        return torch.stack(img4, 0), torch.cat(label4, 0), path4, shapes4, None
...
def load_mosaic(self, index):
    ...
    img4, labels4, feats4 = random_perspective(img4, labels4, segments4,
