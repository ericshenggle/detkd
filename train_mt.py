...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Loggers
    if RANK in [-1, 0]:
        loggers = Loggers(save_dir, weights, opt, hyp, data_dic_lis[0], LOGGER).start()  # loggers dict
    ...
    train_loader_lis=[]
    dataset_lis=[]
    train_loader, dataset = create_dataloader(train_path_lis, imgsz, batch_size // WORLD_SIZE, gs, single_cls,
    ...
    # Process 0
    if RANK in [-1, 0]:
        val_loader = create_dataloader(val_path_lis[0], imgsz, batch_size // WORLD_SIZE * 2, gs, single_cls,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data/coco128.yaml,data/VOC.yaml', help='dataset.yaml path')
